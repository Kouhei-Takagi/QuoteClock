function updateClock() {
    ...
    const minutesDegree = (minutes / 60) * 360; // + 90を削除
    const hoursDegree = ((hours + minutes / 60) / 12) * 360; // + 90を削除
...
"Create your opinions, otherwise other person makes your opinions. - Kouhei Takagi"
    ];
